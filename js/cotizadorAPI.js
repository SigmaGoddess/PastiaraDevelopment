document.addEventListener("DOMContentLoaded", async function () {
    ...
    // 1. Obtén el token (como ya lo tienes)
    ...
    if (!token) {
        ...
        Swal.fire({
            ...
            window.location.href = '/pages/pag-registro/registro.html'; // Redirección a la página de registro
        });

        return;
    }

    // 2. --- ¡LLAMA A LA FUNCIÓN DE CARGA AQUÍ! ---
                                                                ...
                                                                <div class="card product-card" id="producto">
                                                                    ...
                                                                    <div>
                                                                        <div
                                                                            ...
                                                                            <span class="fs-5 fw-bold">$${producto.precio.toFixed(2)}</span>
                                                                        </div>
                                                                        <div
